...
```javascript
setProps = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-meta-data-props@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/strided-base-meta-data-props/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/strided-base-meta-data-props/actions/workflows/test.yml?query=branch:v0.2.3
